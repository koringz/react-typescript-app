...
const ModifyUserForm: React.FC<IProps> = ({ loading, visible, onOk, onCancel }) => {
...
const Header = (props: any) => {
    ...
    return (
        <div className="header-container">
            <div className="header">
                <div className="section">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="https://blog.csdn.net/qq_15041931" target="_blank" rel="noopener noreferrer">
                                CSDN
                            </a>
                        </li>
                    </ul>
            ...
            <ModifyUserForm visible={visible} loading={loading} onOk={onOk} onCancel={onCancel} />
        </div>
    )
}
